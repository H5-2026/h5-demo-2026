(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_69f5889e902c486d3a00f646")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '69d5f727af4cf4b79805b0f8';
_mrmcp['creative_id'] = '69f5889e902c486d3a00f646';
...
_mrmcp['height'] = _mrmcp['height'] || 532;
_mrmcp['type'] = 'smart';
_mrmcp['title'] = '橙衣执甲绽芳华——记灵台全国三八红旗集体环卫女工';
_mrmcp['build_number'] = parseInt('359');
_mrmcp['publish_time'] = 'Mon May 04 2026 17:26:21 GMT+0800 (China Standard Time)';
_mrmcp['last_modified'] = '';
_mrmcp['jsapi_config_url'] = '';
_mrmcp['stat_host'] = 'https://69f5889e902c486d3a00f646.stat.mugeda.com/stats/c.gif';
...
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '0.3.59';
...
window['Mugeda']['Loader'] = function (dom, hasScript, _mrmcp) {
    ...
    if(!Mugeda['css3PlayerLoaded']) {
        ...
        loadRes(1, jsPath + that.crid + ".js?publishTime=1777886781969", [], undefined, function(callback){
            var chk = function(){
...
Mugeda.Loader.prototype.start = function () {
    if (2 == Mugeda.css3PlayerLoaded) {
        ...
        Mugeda['startAnimation']("id_" + this.crid, false ? "actions_" + this.crid + ".js?publishTime=1777886781969" : "", a, this.resDir, this.name, null, this._mrmcp)
    }
    else {
